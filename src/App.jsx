...
function App() {
  ...
  // Pequeña función para mantener los botones limpios
  ...
  return (
    <div className="flex h-screen bg-gray-50 font-sans">
      ...
      <div className="w-64 bg-gray-900 text-white flex flex-col shadow-xl z-10">
        <div className="p-6">
          <h2 className="text-2xl font-extrabold text-blue-400 tracking-tight mb-0">Academia PRO</h2>
        ...
        <nav className="flex-1 px-4 space-y-2 mt-2 overflow-y-auto">
          ...
          <NavButton id="ajustes" icon={Settings} text="Ajustes" />
        </nav>
      </div>
